...
BENCH_FUNC(bench_aes_ctr_256_encrypt)
{
    ...
    aesv_ctr_256_encrypt(data, blocks, key, IV);
...
BENCH_FUNC(bench_aes_ctr_256_decrypt)
{
    ...
    aesv_ctr_256_decrypt(data, blocks, key, IV);
...
BENCH_FUNC(bench_aes_cfb_256_encrypt)
{
    ...
    aesv_cfb_256_encrypt(data, blocks, key, IV);
...
BENCH_FUNC(bench_aes_cfb_256_decrypt)
{
    ...
    aesv_cfb_256_decrypt(data, blocks, key, IV);
...
BENCH_FUNC(bench_aes_ofb_256_encrypt)
{
    ...
    aesv_ofb_256_encrypt(data, blocks, key, IV);
...
BENCH_FUNC(bench_aes_ofb_256_decrypt)
{
    ...
    aesv_ofb_256_decrypt(data, blocks, key, IV);
...
BENCH_FUNC(bench_aes_ecb_256_encrypt)
{
    ...
    aesv_ecb_256_encrypt(data, blocks, key);
...
BENCH_FUNC(bench_aes_ecb_256_decrypt)
{
    ...
    aesv_ecb_256_decrypt(data, blocks, key);
...
BENCH_FUNC(bench_aes_cbc_256_encrypt)
{
    ...
    aesv_cbc_256_encrypt(data, blocks, key, IV);
...
BENCH_FUNC(bench_aes_cbc_256_decrypt)
{
    ...
    aesv_cbc_256_decrypt(data, blocks, key, IV);
