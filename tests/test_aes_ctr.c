...
MU_TEST(test_aes_ctr_128_encrypt)
{
    ...
    aes_ctr_128_encrypt(d, 4, key, IV); // encrypt plaintext in place
...
MU_TEST(test_aes_ctr_128_decrypt)
{
    ...
    aes_ctr_128_decrypt(d, 4, key, IV); // decrypt ciphertext in place
...
MU_TEST(test_aes_ctr_192_encrypt)
{
    ...
    aes_ctr_192_encrypt(d, 4, key, IV); // encrypt plaintext in place
...
MU_TEST(test_aes_ctr_192_decrypt)
{
    ...
    aes_ctr_192_decrypt(d, 4, key, IV); // decrypt ciphertext in place
...
MU_TEST(test_aes_ctr_256_encrypt)
{
    ...
    aes_ctr_256_encrypt(d, 4, key, IV); // encrypt plaintext in place
...
MU_TEST(test_aes_ctr_256_decrypt)
{
    ...
    aes_ctr_256_decrypt(d, 4, key, IV); // decrypt ciphertext in place
